...
class Palette(BaseModel):
    ...
    def set_input(self, data):
        ...
        self.identity_image = self.set_device(data.get('identity_image'))
    ...
    def train_step(self):
        ...
        for train_data in tqdm.tqdm(self.phase_loader):
            ...
            self.optG.zero_grad()
            loss = self.netG(self.gt_image, self.cond_image, self.identity_image, self.mask, self.audio)
            loss.backward()
            self.optG.step()
    ...
    def val_step(self):
        ...
        print('vaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaal')
        with torch.no_grad():
